...
const Blog = () => {
  ...
  const blogPosts = [
    {
      id: 1,
      title: 'آموزش کامل خرید و فروش ارز',
      excerpt: 'راهنمای جامع معاملات ارز با کمترین کارمزد و بالاترین امنیت',
    ...
    {
      id: 6,
      title: 'ارز چیست و چگونه کار می‌کند؟',
      excerpt: 'بررسی کامل ارز و مکانیسم‌های پشتیبانی آن',
      image: '../../public/media/images/bg_home.webp',
      date: '۱۴۰۲/۰۴/۱۵',
      author: 'تحلیلگر ارشد',
      category: 'آموزشی',
